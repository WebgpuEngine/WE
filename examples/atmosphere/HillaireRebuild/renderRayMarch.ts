...
import shaderVS from "./vs/ndc_base_1.wgsl?raw";
...
import shaderLutSkyview from "./output/lut_skyview.wgsl?raw";
let shaderLutSkyviewCommon =
  shader_const +
  shader_struct +
  shader_intersection +
  shader_medium +
...
import shaderLutApOverride from "./output/lut_ap_override.wgsl?raw";
import shaderLutAp from "./output/lut_ap.wgsl?raw";
let shaderLutApCommon =
  shader_const +
  shader_struct +
  shader_intersection +
  shader_medium +
  ...
  shader_sample_segment_t
  ;

import shaderRenderWithRayMarchingO from "./output/renderRayMarching.wgsl?raw";
import shaderRenderWithRayMarchingOverride from "./output/renderRayMarching_override.wgsl?raw";
let shaderRenderWithRayMarchingCommon =
  shader_const +
  shader_struct +
  shader_intersection +
  shader_medium +
  ...
  let options: IV_ComputeCommand = {
    ...
    computeInfo: {
      ...
      pipeline: {
        pipelineLayout: pipelineLayout,
        shader: {
          shaderCode: shaderLutMulittransOverride + shaderLutMulittransCommon + shaderLutMulittrans,
  ...
  let options: IV_ComputeCommand = {
    ...
    computeInfo: {
      ...
      pipeline: {
        pipelineLayout: pipelineLayout,
        shader: {
          shaderCode: shaderLutSkyviewOverride + shaderLutSkyviewCommon + shaderLutSkyview,
  ...
  let options: IV_ComputeCommand = {
    ...
    computeInfo: {
      ...
      pipeline: {
        pipelineLayout: pipelineLayout,
        shader: {
          shaderCode: shaderLutApOverride + shaderLutApCommon + shaderLutAp,
...
let dc;
{
  ...
  let valueDC: IV_DC = {
    ...
    render: {
      ...
      fragment: {
        code: shaderRenderWithRayMarchingOverride + shaderRenderWithRayMarchingCommon + shaderRenderWithRayMarchingO,
        entryPoint: "fragment",
