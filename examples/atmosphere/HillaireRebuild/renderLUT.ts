...
import shaderRenderWithLUT from "./output/renderWithLUT.wgsl?raw";
import shaderRenderWithLUTOverride from "./output/renderWithLUT_override.wgsl?raw";
let shaderRenderWithLUTCommon =
  shader_const +
  shader_struct +
  shader_intersection +
  shader_medium +
...
let dc;
{
  ...
  let valueDC: IV_DC = {
    ...
    render: {
      ...
      fragment: {
        code: shaderRenderWithLUTOverride + shaderRenderWithLUTCommon + shaderRenderWithLUT,
        entryPoint: "fragment",
