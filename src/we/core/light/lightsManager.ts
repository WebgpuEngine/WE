...
import type { bindGroupAndGroupLayout } from "../command/DrawCommandGenerator";
import { commmandType } from "../scene/base";
import { shadowMapSize } from "../base/coreDefine";

export interface optionLightSManager {
    scene: Scene,
    lightCount: number,
}
/**
...
export class LightsManager {
    ...
    */
    ...
    constructor(input: optionLightSManager) {
    ...
    */
     ...
     */
    getLightBindGroupAndBindGroupLayout(mergeID: string): bindGroupAndGroupLayout {
