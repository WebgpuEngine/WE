...
export interface IV_LatheGeometryGemetry extends IV_Gemetry {
...
export class LatheGeometry extends BaseGeometry {
    ...
    /**box的参数 */
    parameters!: IV_LatheGeometryGemetry;
    ...
    constructor(input: IV_LatheGeometryGemetry) {
    ...
    init(input: IV_LatheGeometryGemetry) {
